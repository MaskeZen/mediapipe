...
// Example config:
// node {
//   calculator: "OpenCvImageDecoderCalculator"
...
// }
//
class OpenCvImageDecoderCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Open(CalculatorContext* cc) override {
    ...
    cap_ = absl::make_unique<cv::imread>(input_file_path);
    if (!cap_->isOpened()) {
...
#else
      return mediapipe::InvalidArgumentErrorBuilder(MEDIAPIPE_LOC)
             << "OpenCvImageDecoderCalculator can't save the audio file "
...
REGISTER_CALCULATOR(OpenCvImageDecoderCalculator);
}  // namespace mediapipe
